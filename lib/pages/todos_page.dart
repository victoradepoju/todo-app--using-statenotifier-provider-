...
import 'package:flutter_app/utils/debounce.dart';
...
class SearchAndFilterTodo extends StatelessWidget {
  SearchAndFilterTodo({Key? key})
      : super(key: key); //const keyword deleted. why?
    ...
    return ListView.separated(
      ...
      itemBuilder: (BuildContext context, int index) {
        return Dismissible(
            ...
            onDismissed: (_) {
              //why does it not take any argument?
...
class _TodoItemState extends State<TodoItem> {
  ...
  Widget build(BuildContext context) {
    return ListTile(
        ...
        showDialog(
            ...
            builder: (context) {
              ...
              return StatefulBuilder(
                  //because it isn't scopped to a current location? What does that mean?
      ...
      leading: Checkbox(
        value: widget.todo
            .completed, //widget refers to the TodoItem widget itself and since it has
        //a todo property, it is possible to access it.
